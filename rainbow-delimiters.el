...
;;; Customize interface:
(message "modified rainbow delimeters mode \n")
...
(defface rainbow-delimiters-depth-1-face
  '((((background light)) (:foreground "#000080"))
    (((background dark)) (:foreground "#c0c0c0" :bold t)))
